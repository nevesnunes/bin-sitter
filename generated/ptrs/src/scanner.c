...
bool tree_sitter_ptrs_external_scanner_scan(void *payload,
                                            TSLexer *lexer,
...
void *tree_sitter_ptrs_external_scanner_create() {
    if (_ts_err == NULL) {
...
void tree_sitter_ptrs_external_scanner_destroy(void *payload) {
    if (_bs_in != -1 && close(_bs_in) != 0) {
...
unsigned tree_sitter_ptrs_external_scanner_serialize(void *payload,
                                                     char *buffer) {
    return 0;
}
void tree_sitter_ptrs_external_scanner_deserialize(void *payload,
                                                   char *buffer,
                                                   unsigned length) {}
